...
export const metadata: Metadata = {
  ...
  creator: 'OPENDOOR',
  metadataBase: new URL('https://www.serruriernarbonne.fr'),
  openGraph: {
    type: 'website',
    locale: 'fr_FR',
    url: 'https://www.serruriernarbonne.fr',
    siteName: 'OPENDOOR',
...
const jsonLd = {
  ...
  '@type': 'LocalBusiness',
  '@id': 'https://www.serruriernarbonne.fr',
  name: 'OPENDOOR',
  ...
  email: 'eugene80aurelien@gmail.com',
  image: 'https://www.serruriernarbonne.fr/logo.svg',
  priceRange: '€€',
  address: {
    '@type': 'PostalAddress',
