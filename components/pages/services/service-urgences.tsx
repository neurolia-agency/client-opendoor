...
const inclus = [
  'Ouverture de porte claquée (sans dégâts)',
  'Ouverture de porte verrouillée',
  'Ouverture de porte blindée',
  'Réparation après effraction',
  'Sécurisation immédiate du domicile',
  'Dépannage de serrures (problèmes mécaniques)',
]

export default function ServiceUrgences() {
  return (
    <section id="urgences" className="relative overflow-hidden" style={{ backgroundColor: 'var(--background-alt)' }}>
      ...
      <div className="container-custom relative z-10 section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Intervention rapide pour toutes les situations d'urgence liées à vos serrures. Porte claquée, porte verrouillée, effraction : nous intervenons 24h/24 pour vous permettre de retrouver l'accès à votre domicile en toute sécurité.
            </p>

            {/* Trust signals — outline pills (same vocabulary as 24h/24 badge) */}
          ...
          {/* Right column - Image placeholder + Included list */}
          <motion.div
          ...
          >
            ...
            >
              <Image
                src="/images/nous-sommes-la.png"
                alt="Serrurier OPENDOOR en intervention d'urgence"
                fill
